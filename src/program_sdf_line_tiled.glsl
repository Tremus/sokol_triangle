...
out flat int tile_begin_idx;
out flat int tile_end_idx;
...
void main() {
    ...
    tile_begin_idx   = vert.tile_begin_idx;
    tile_end_idx     = vert.tile_end_idx;
}
@end
...
in flat int tile_begin_idx;
in flat int tile_end_idx;
...
layout(binding=1)readonly buffer storage_buffer {
...
void main()
{
    ...
    // float tile_len = float(tile_end_idx - tile_begin_idx);
